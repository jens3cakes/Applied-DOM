(function (window) {
  ...
  function setMyLightGreen() {
    ...
    let lightGreenB = document.getElementById(lightId);
    lightGreenB.className = 'light-green';
  ...
  function setMyLightClass(event, desiredClass) {
    let lightId = this.dataset.lightId;
    let searchId = document.getElementById(lightId)
    searchId.className = desiredClass
  };
  /*
